...
def process_all_videos(input_directory, output_directory):
    ...
    for mp4_file in input_directory.rglob("*.mp4"):
        ...
        try:
            ...
            temp_path = temp_directory / relative_path.parent
            final_output = output_directory / (relative_path.stem + "_final.mp4")
...
if __name__ == "__main__":
    input_directory = "/home/work/data/ko/clips1"
    output_directory = "/home/work/data/aihub_preprocessed"
