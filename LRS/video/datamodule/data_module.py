...
class DataModule(LightningDataModule):
    def __init__(self, cfg=None):
        ...
        self.train_filenames = glob(f"/home/work/data/aihub_pkl/train/*/*.pkl")
        self.val_filenames = glob(f"/home/work/data/aihub_pkl/val/*/*.pkl")
        self.test_filenames = glob(f"/home/work/data/aihub_pkl/main/*/*.pkl")
